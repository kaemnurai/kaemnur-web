  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 lg:px-8 lg:py-12">
      ...
      <p className="mt-2 text-[14px] text-fg-sub">
        Informasi seputar download, lisensi, aktivasi, pembaruan, dan penggunaan
        aplikasi Kaemnur.
      </p>
      ...
      <div className="mt-10 rounded-card border border-line bg-card p-6 text-center">
        <p className="text-[16px] font-semibold text-fg">Masih butuh bantuan?</p>
        ...
        <a
          ...
          className="mt-5 flex h-11 w-full items-center justify-center gap-2 rounded-btn bg-accent text-[14px] font-semibold text-bg hover:bg-accent-hover"
        >
          {/* WhatsApp icon */}
